...
export async function getChapterAttachments(chapterId) {
...
export async function deleteChapterAttachment(attachmentId, storagePath) {
...
export async function getChapterAttachmentUrl(storagePath) {
